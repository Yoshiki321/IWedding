...

{
    ...
    public class VRCapture : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            //{
            //    if (cloneCamFL != null && camfl != null)
            //    {
            //        Vector3 IPD = new Vector3(0, 0, 0);
        ...
        void LateUpdate()
        {
            ...
            else
            {
                ...
                if (step == 3)
                {
                    ...
                    if (imgCount > 1)
                    {
                        ffmpegPath = Application.dataPath + "\\VRPanorama\\StreamingAssets\\";
                        System.Diagnostics.Process.Start(ffmpegPath + "ffmpeg", " -f image2" + " -framerate " + FPS + " -i \"" + fullPath + _prefix + "%05d" + formatString + " -r " + FPS + " -vcodec libx264 -y -pix_fmt yuv420p -b:v " + Mp4Bitrate + "k \"" + System.Environment.GetFolderPath(System.Environment.SpecialFolder.Desktop)+"\\" + Folder + ".mp4\"");
        ...
        public void SaveScreenshot()
        {
            ...
            if (ImageFormatType == VRFormatList.JPG)
            {
                ...
                string filePathf = string.Format(fullPath + _prefix + "{1:D05}" + timestamp + ".jpg", Folder, imgCount);
                formatString = ".jpg\"";
