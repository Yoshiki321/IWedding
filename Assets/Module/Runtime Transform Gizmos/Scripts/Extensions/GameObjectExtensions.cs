...
namespace RTEditor
{
    ...
    public static class GameObjectExtensions
    {
        ...
        public static Box GetColliderModelSpaceBox(this GameObject gameObject)
        {
            ...
            //BoxCollider[] ms = gameObject.GetComponentsInChildren<BoxCollider>();
            ...
            //float maxx = 0;
            //for (int i = 0; i < xs.Length; i++) maxx = Mathf.Max(maxx, xs[i]);

            //float maxy = 0;
            //for (int i = 0; i < ys.Length; i++) maxy = Mathf.Max(maxy, ys[i]);

            //float maxz = 0;
            //for (int i = 0; i < zs.Length; i++) maxz = Mathf.Max(maxz, zs[i]);

            Vector3 c = gameObject.GetBoxColliderCenter();
            Vector3 v = gameObject.GetBoxColliderSize();

            modelSpaceBox = new Box(c, v);
